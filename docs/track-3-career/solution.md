...
<div className="row margin-bottom--lg">
  <div className="col col--6">
    <div style={{background: '#f8f9fa', padding: '2rem', borderRadius: '12px', border: '1px solid #eee', height: '100%'}}>
      <h4 style={{textTransform: 'uppercase', color: '#888'}}>Traditional AI Training</h4>
      <ul style={{fontSize: '0.9rem'}}>
        <li>"Here's how to use ChatGPT"</li>
  ...
  <div className="col col--6">
    <div style={{background: '#fffafa', padding: '2rem', borderRadius: '12px', border: '1px solid var(--pitch-accent)', height: '100%'}}>
      <h4 style={{textTransform: 'uppercase', color: 'var(--pitch-accent)'}}>The SkaFld Approach</h4>
      <ul style={{fontSize: '0.9rem'}}>
        <li>"Here's how to THINK about problems"</li>
        <li>Decomposition methodology</li>
        <li>Cross-domain pattern recognition</li>
        <li>Meta-cognitive skill building</li>
      </ul>
    </div>
  </div>
</div>
...
Students learn to look OUTSIDE their immediate domain before assuming they need to invent something new. This **interdisciplinary approach** mirrors the cross-pollination that drives innovation at institutions like Stanford.

**2. Decomposition Thinking**
Every complex challenge can be broken down into smaller, more manageable decisions. Students learn to decompose problems until they reach actionable yes/no questions.
